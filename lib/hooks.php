<?php
	...
	function file_tree_write_acl_plugin_hook($hook, $type, $returnvalue, $params){
		$result = $returnvalue;
		
		if(!empty($params) && is_array($params)){
			
			if((get_context() == "file_tree") && ($page_owner = page_owner_entity()) && ($page_owner instanceof ElggGroup)){
				$result = array(
